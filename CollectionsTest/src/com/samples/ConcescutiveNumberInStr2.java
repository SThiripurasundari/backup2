...
public class ConcescutiveNumberInStr2 {
	...
	public static void main(String[] args) {
		/*
		 * String str = "99100"; System.out.println("String: " + str); int start =
		 * isConsecutive(str); if (start != -1) System.out.println("Yes \n" + start);
		 * else System.out.println("No");
		 */

		String str1 = "121314";
		System.out.println("\nString: " + str1);
		int start = isConsecutive(str1);
		if (start != -1)
